...
$(document).ready(function(){
    var options = {
        ...
        interval: 15000, // Interval to slide on if slideOnInterval is enabled
    ...
    $(".slide#first").backstretch("assets/img/bg/responsive.jpg");
    $(".slide#second").backstretch("assets/img/bg/business-solutions.jpg");
    $(".slide#thirth").backstretch("assets/img/bg/bootstrap-development.jpg");
    $(".slide#fourth").backstretch("assets/img/bg/bay-area.jpg");
